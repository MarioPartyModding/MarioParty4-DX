#To be inserted at 8008cf14
# MP4 ITEM EXPANSION MOD GECKO CODE - UpdateItemPickup Large Icon
# Large Icon code for the UpdateItemPickup function.
# The value of r4 is 4 * item ID. It's higher than 0x34 for all custom items.
cmpwi r4, 0x34
ble is_not_custom_item

li r3, 4
divw r3, r4, r3 # Get Item ID
subi r3, r3, 0xE 
